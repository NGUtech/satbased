...
final class VerificationToken extends Entity
{
    ...
    public function verify(Sha256 $token, Timestamp $time): bool
    {
        //@todo eliminate empty used for fixtures
        return ($token->isEmpty() || $this->getToken()->equals($token))
